...
public class motherSideBarController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
       ...
       ShopClick.setOnMouseClicked((mouseEvent -> {
        ...
        EtabClick.setOnMouseClicked((mouseEvent -> {
            try{
                FXMLLoader loader2= new FXMLLoader();
                loader2.setLocation(getClass().getResource("/AfficherEtablissement.fxml"));
                Parent root = loader2.load();
                initialPage.setCenter(root);
            } catch (IOException e) {
                e.printStackTrace();
        ...
        appointmentclick.setOnMouseClicked((mouseEvent -> {
            try{
                FXMLLoader loader2= new FXMLLoader();
                loader2.setLocation(getClass().getResource("/AjouterRendezVous.fxml"));
                Parent root = loader2.load();
                initialPage.setCenter(root);
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public String getUserImageDirectory() {
        String imagesDirectory = "C/Users/eya/Desktop/JavaFx/BellyBump_Desktop/src/main/resources/assets/images/";
    ...
    private void handleUploadButton(ActionEvent event) {
        ...
        if (selectedFile != null) {
            ...
            String destinationDirectoryPath = "C/Users/eya/Desktop/JavaFx/BellyBump_Desktop/src/main/resources/assets/images/";
