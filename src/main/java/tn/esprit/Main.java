...
public class Main {
    public static void main(String[] args) {
       ...
       User u1=new User("admin","admin","admin@gmail.com","admin","admin","image", Date.valueOf("2021-04-29"),98765432);
        User u2=new User("wiembm2001@gmail.com","password2","rihab","benmansour","tunis","iamge2", Date.valueOf("2021-04-29"),12345678);
     //   us.add(u2);
       us.add(u1);
       ...
       us.getUsersCreatedPerMonth();*/
        Task t=new Task(15,"i have to be done from my duties","homework");
        Task t2=new Task(1,"i have to be done from my duties","homework");
        Task t3=new Task(1,"i have to be done from my duties","homework");
       // ts.add(t,224);
          // us.delete(u2);
         // ts.update(t);
        // ts.delete(t);
       // List<Task> tasks = ts.getAll("wiembm2001@gmail.com");
      //  ts.getOne(15,226);
